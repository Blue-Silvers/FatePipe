...
templates = {
    ...
    "shot_item": {"glob": "Shot/Ep001/{asset_type}/{asset_name}/{asset_task}/{asset_version}/{shot_item}",
                   "regex": 'Shot/Ep001/(?P<asset_type>.*)/(?P<asset_name>.*)/(?P<asset_task>.*)/(?P<asset_version>.*)/(?P<shot_item>.*)',
                   },
}
